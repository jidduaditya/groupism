        ...
        {addState.mode === "idle" && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="h-11 px-5 rounded-[4px] border border-b-mid bg-transparent font-ui text-sm text-t-primary hover:bg-hover transition-all duration-150 active:scale-[0.95] cursor-pointer whitespace-nowrap disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Search
            </button>
            ...
            <div className="border-t border-b-subtle pt-4">
              ...
              <button
                ...
                className="mt-2 h-11 px-5 rounded-[4px] border border-b-mid bg-transparent font-ui text-sm text-t-primary hover:bg-hover transition-all duration-150 active:scale-[0.95] cursor-pointer whitespace-nowrap"
              >
                Suggest →
              </button>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              {addState.suggestions.map((name) => (
                <button
                  ...
                  className="h-11 px-5 rounded-[4px] bg-surface border border-b-mid font-ui text-sm text-t-primary hover:bg-hover transition-all duration-150 active:scale-[0.95] cursor-pointer"
                >
                  {name}
                </button>
              ))}
